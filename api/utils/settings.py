...
class Settings(BaseSettings):
    ...
    # When True, exposes /api/v1/hng-test and /api/v1/all/run-tests (DoS / RCE risk). Keep False in production.
    ENABLE_INSECURE_TEST_ENDPOINTS: bool = config(
        "ENABLE_INSECURE_TEST_ENDPOINTS", default=False, cast=bool
    )
